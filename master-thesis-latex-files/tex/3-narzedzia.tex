...
\begin{figure}[!h]
    \centering \includegraphics[width=0.8\linewidth]{img/architektura-agent.png}
...
\begin{figure}[!h]
    \centering \includegraphics[width=0.9\linewidth]{img/architektura-agent-architekt.png}
...
\begin{figure}[!h]
    \centering \includegraphics[width=0.9\linewidth]{img/architektura-wieloagentowa.png}
